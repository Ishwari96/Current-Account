...
insert into customer (id,creationTime,name,surname) VALUES (2,CURRENT_TIMESTAMP,'Stefan','Martine');
insert into customer (id,creationTime,name,surname) VALUES (3,CURRENT_TIMESTAMP,'Sebnem','Ozec');
insert into customer (id,creationTime,name,surname) VALUES (4,CURRENT_TIMESTAMP,'Erik','Dijk');
